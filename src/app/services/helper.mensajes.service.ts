...
export class HelperMensajesService {
  ...
  public MSJ_ERROR_COMPLEMENTO_CITA: string = 'No fue posible conectar con el servicio';
  public MSJ_ERROR_DATOS_UM: string = 'No fue posible obtener los datos de la Unidad Médica, revise configuración de catálogos.';
