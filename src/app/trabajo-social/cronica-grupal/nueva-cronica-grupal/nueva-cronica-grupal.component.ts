...
@Component({
  selector: 'app-nueva-cronica-grupal',
  templateUrl: './nueva-cronica-grupal.component.html',
  styleUrls: ['./nueva-cronica-grupal.component.css']
})
export class NuevaCronicaGrupalComponent implements OnInit, AfterViewInit {
