...
@Component({
  selector: 'app-lista-cronica-grupal',
  templateUrl: './lista-cronica-grupal.component.html',
  styleUrls: ['./lista-cronica-grupal.component.css']
})
export class ListaCronicaGrupalComponent implements OnInit, AfterViewInit {
