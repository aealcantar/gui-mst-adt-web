...
import { ConsultaAvisoMpComponent } from './avisos-ministerio-publico/consulta-aviso-mp/consulta-aviso-mp.component'
...
const routes: Routes = [
  ...
  {
    path: 'busqueda',
    component: BusquedaNssComponent,
  ...
  {
    path: 'nueva-cronica-cero',
    component: NuevaCronicaDesdeCeroComponent,
    canActivate: [SeguridadRouter],
  },
  {
    path: 'detalle-cronica-cero',
    component: DetalleCronicaDesdeCeroComponent,
    canActivate: [SeguridadRouter],
  },
  ...
  {
    path: 'nuevo-certificado-defuncion',
  ...
  {
    path: 'consulta-certificado-defuncion',
